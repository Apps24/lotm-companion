...
const home=text("app/page.tsx"); ["/read","/chapters","/klein","/tarot","/world","/timeline","/visuals","/chapters/2"].forEach(h=>ok(home.includes(h),`homepage missing link ${h}`));
const nav=text("app/components/SiteNav.tsx"); ["Home","Read","Chapters","Klein","Tarot Club","World","Timeline / Search","Visuals"].forEach(x=>ok(nav.includes(x),`global nav missing ${x}`));
